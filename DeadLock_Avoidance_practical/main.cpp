...
void dine(int nphilo) {
    ...
    print(nphilo, "\'s reach for forks ", lfork, rfork);

    //try to pick up the both forks
    std::lock(mutex_forks[lfork], mutex_forks[rfork]);
    ...
    print(nphilo, " puts down the forks ", lfork, rfork);
